...
@section('content')
    <div class="wrapper">
        ...
        <div class="section section-dark section-clients">
        ...
        <div class="section section-presentation brand-background">
            <div class="container">
                <div class="row">
        ...
        <div class="section section-presentation section-gray section-no-padding" style="color:#000">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="description">
                            <h4 class="header-text">ARCMF</h4>
                            <p>Our mission framework is based on <a href="https://github.com/ferstaberinde/F3" target="_newtab">F3</a> with some extra features and overhauls to improve our experience and provide robust missions.</p>
                        </div>
                    </div>
                    <div class="col-md-6 hidden-xs">
                        <img class="brand-gradient" src="{{ url('/images/public/banners/mars-g.jpg') }}"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="section section-no-padding">
            <div class="parallax">
                ...
                <div class="info">
                    <h1>Are you ready?</h1>
                    <a href="{{ url('/join') }}" class="btn btn-primary btn-lg btn-fill">Submit Your Application</a>
                </div>
            </div>
        </div>
    </div>
